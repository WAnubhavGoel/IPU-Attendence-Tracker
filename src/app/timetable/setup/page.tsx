    ...
    <div className="page-content" style={{ paddingTop: 20 }}>
      ...
      <div style={{ marginBottom: 20 }}>
        <h1 style={{ fontSize: "1.5rem", fontWeight: 800, marginBottom: 4 }}>
          {step === 1 ? (
            <><span className="grad-text">Set Up</span> Timetable</>
          ) : hasTimetable ? (
            <><span className="grad-text">Edit</span> Timetable</>
          ) : (
            <><span className="grad-text">Review</span> Schedule</>
          )}
        </h1>
        <p style={{ color: "var(--text-muted)", fontSize: "0.85rem" }}>
          {step === 1
            ? "Upload your college timetable image — AI will extract all classes"
            : hasTimetable
            ? "Edit your subjects, class counts, and session start date"
            : "Specify when classes start and review your subjects"}
        </p>
      </div>
